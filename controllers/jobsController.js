...
const getAllJobs = async (req, res) => {
    ...
    if (sort === "lates") result = result.sort("-createdAt");
...
const updateJob = async (req, res) => {
    ...
    if (!company || !position) throw new BadRequestError("Please provide all values");
...
const showStats = async (req, res) => {
    ...
    res.status(StatusCodes.OK).json({ monthlyApplications, defaultStats });
}
